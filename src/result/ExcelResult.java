...
public class ExcelResult extends JFrame{
	...
	public ExcelResult(JFrame frame)
	{
		super("Show Result Dialogue Box");
	  ...
	  void fillData(File file)
	      {
	        ...
	        try {
	               try {
	                    ...
	                    {
	                         Logger.getLogger(ExcelResult.class. getName()).log(Level.SEVERE, null, ex);
	                     }
